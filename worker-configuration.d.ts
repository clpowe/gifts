/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 93379c0b8c73be0ae3f4940dc734c02f)
// Runtime types generated with workerd@1.20260521.1 2026-05-25 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	NUXT_GEMINI_API_KEY: string;
	BETTER_AUTH_SECRET: string;
	BETTER_AUTH_URL: string;
	GOOGLE_CLIENT_ID: string;
	GOOGLE_CLIENT_SECRET: string;
	NUXT_CLOUDFLARE_ACCOUNT_ID: string;
	NUXT_CLOUDFLARE_DATABASE_ID: string;
	NUXT_CLOUDFLARE_D1_TOKEN: string;
	DB?: D1Database;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_GEMINI_API_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "NUXT_CLOUDFLARE_ACCOUNT_ID" | "NUXT_CLOUDFLARE_DATABASE_ID" | "NUXT_CLOUDFLARE_D1_TOKEN">> {}
}
